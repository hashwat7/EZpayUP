      ...
      {authToken ? (
        <>
          <div className="bg-gray-100">
            <Link className="pointer  pl-1 cursor-pointer" to="/dashboard">
              <div className="w-100 flex justify-start">
                ...
                <span className="text-lg text-slate-700 no-underline">
                  Go back
                </span>
              </div>
            </Link>
            <div className="flex justify-center h-screen">
              <div className="mt-20 h-1/2 flex flex-col justify-center">
